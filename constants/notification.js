...
const NOTIFICATION_TYPE = {
  ...
  // Product moderation (admin → seller) — in-app + FCM
...
const NOTIFICATION_TYPE_DEFAULT_ROLE = {
  ...
  [NOTIFICATION_TYPE.PRODUCT_APPROVED]: NOTIFICATION_ROLE.SELLER,
  [NOTIFICATION_TYPE.PRODUCT_REVISION_REQUIRED]: NOTIFICATION_ROLE.SELLER,
  [NOTIFICATION_TYPE.PRODUCT_REJECTED]: NOTIFICATION_ROLE.SELLER,
 ...
 * Excludes chat pushes (CHAT_MESSAGE only).
 */
const IN_APP_NOTIFICATION_TYPES = [
  ...
  NOTIFICATION_TYPE.PRODUCT_REVISION_REQUIRED,
